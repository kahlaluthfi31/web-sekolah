...
const LEVEL_VALUES = LEVELS.filter((l) => l.value !== "_lainnya").map(
  (l) => l.value,
);
...
function AchievementFormModal({
  ...
  useEffect(() => {
    if (achievement) {
      ...
      setForm({
        ...
        competitionDate: achievement.competitionDate
          ? achievement.competitionDate.substring(0, 10)
          : "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const finalLevel =
      form.level === "_lainnya" ? form.customLevel.trim() : form.level;
    if (!finalLevel) {
    ...
    if (
      ...
      form.competitionDate > new Date().toISOString().split("T")[0]
    ) {
              ...
              <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setForm((f) => ({ ...f, classGrade: e.target.value }))
                        }
                        className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      >
                        {CLASSES.map((c) => (
                  ...
                  {form.level === "_lainnya" && (
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1.5">
                        Tingkat Kustom <span className="text-red-500">*</span>
                      </label>
                      <input
                        type="text"
                ...
                <div className="space-y-5">
                  <div className="bg-white rounded-2xl border border-gray-100 p-5 space-y-4">
                    <h3 className="font-semibold text-gray-900 text-sm flex items-center gap-2">
                      <ImageIcon className="w-4 h-4 text-blue-500" /> Foto Bukti
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Kelola data prestasi dan kejuaraan siswa
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        >
          ...
          {LEVELS.filter((l) => l.value !== "_lainnya").map((l) => (
            <option key={l.value} value={l.value}>
              {l.label}
            </option>
          ))}
              ...
              <tbody className="divide-y divide-gray-50">
                {data.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <p className="text-sm text-gray-900 truncate max-w-50">
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`text-xs px-2.5 py-1 rounded-full capitalize ${levelColors[item.level] || "bg-gray-100 text-gray-600"}`}
                      >
                        {item.level}
                      </span>
                    </td>
                      ...
                      {item.photo ? (
                        ...
                        >
                          <Image
                            ...
                            width={48}
                            height={48}
                            className="w-12 h-12 rounded-lg object-cover border border-gray-200 group-hover:ring-2 group-hover:ring-blue-400 group-hover:scale-105 transition-all cursor-pointer"
                            unoptimized
                          />
                        </button>
                      ) : (
              ...
              <div className="overflow-y-auto p-6 space-y-4">
                ...
                <div className="divide-y divide-gray-50">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start gap-1 sm:gap-4 py-3">
                    ...
                    <span
                      className={`text-xs px-2.5 py-1 rounded-full capitalize ${levelColors[detailTarget.level] || "bg-gray-100 text-gray-600"}`}
                    >
                      {detailTarget.level}
                    </span>
                  </div>
                  ...
                  {detailTarget.certificateImage && (
                    <div className="flex flex-col sm:flex-row sm:items-start gap-1 sm:gap-4 py-3">
                      ...
                      <Image
                        src={detailTarget.certificateImage}
                        alt="Sertifikat"
                        width={200}
                        height={150}
                        className="rounded-lg object-cover border border-gray-200 cursor-pointer hover:ring-2 hover:ring-blue-400 transition-all"
                        onClick={() => {
                          setDetailTarget(null);
                          setPreviewPhoto(detailTarget.certificateImage);
                        }}
                        unoptimized
                      />
                    </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start gap-1 sm:gap-4 py-3">
                    ...
                    <span className="text-sm text-gray-900 flex-1">
                      {new Date(detailTarget.createdAt).toLocaleDateString(
                        "id-ID",
