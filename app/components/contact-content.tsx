           ...
           <div className="bg-white p-12 rounded-[40px] shadow-2xl border border-gray-50 max-w-5xl mx-auto">
              <form className="space-y-6">
                 ...
                 <div className="text-center pt-6">
                    <button type="submit" className="bg-[#0092DD] text-white px-12 py-4 rounded-xl font-bold shadow-lg hover:bg-[#77C5F0] hover:text-[#0092DD] transition-colors">Submit Message</button>
                 </div>
              </form>
           </div>
        </div>
