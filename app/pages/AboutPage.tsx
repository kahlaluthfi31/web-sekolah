...
const AboutPage: React.FC = () => {
  ...
  const [videoUrl, setVideoUrl] = useState<string>(
    "https://www.youtube.com/embed/jWq8hHCOJkg?si=d1OGiF0YyHodW1PW",
  );
      ...
      .then((json) => {
        if (json.success) {
          ...
          if (setting?.settingValue)
            setVideoUrl(normalizeYoutubeUrl(setting.settingValue));
        }
      })
      .catch(() => {});
  }, []);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Mengenal SMK Negeri 1 Ciamis
            </h2>
            <p className="max-w-2xl mx-auto text-gray-500 leading-relaxed">
              Tonton video profil kami untuk mengetahui lebih dalam tentang
              fasilitas, program keahlian, dan prestasi yang telah diraih.
            </p>
          </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Sejarah SMK Negeri 1 Ciamis
            </h2>
            <p className="max-w-2xl mx-auto text-gray-500 leading-relaxed">
              Perjalanan panjang kami dalam mencetak generasi unggul di bidang
              vokasi
            </p>
          </div>
                  ...
                  return (
                    <div key={item.id} className="flex gap-6 items-stretch">
                      ...
                      <div className="w-17 shrink-0 flex flex-col items-center relative z-10">
                        ...
                        <div
                          className={`w-0.5 flex-1 ${idx === 0 ? "bg-transparent" : "bg-[#0092DD]/25"}`}
                        />
                        {/* Lingkaran tahun */}
                        ...
                        <div
                          className={`w-0.5 flex-1 ${isLast ? "bg-transparent" : "bg-[#0092DD]/25"}`}
                        />
                      </div>
                      {/* Konten kartu */}
                      <div className="flex-1 py-4">
                        <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                          <h3 className="text-base font-bold text-[#0092DD] mb-2">
                            {item.title}
                          </h3>
          ...
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={s.label}
                className="bg-white p-6 rounded-xl shadow text-center border border-gray-100"
              >
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="max-w-2xl mx-auto text-gray-500 leading-relaxed">
              Komitmen kami dalam mewujudkan pendidikan vokasi yang berkualitas
            ...
            <div className="space-y-0">
              ...
              <div className="flex flex-col md:flex-row gap-10 items-center py-10 border-b border-gray-100">
                <div className="flex-1">
                  <h3 className="text-3xl font-bold text-[#0092DD] mb-4">
                    Visi
                  </h3>
                ...
                <div className="flex-1">
                  ...
                  <ul className="space-y-2">
                    {[
                      ...
                      <li
                        key={i}
                        className="flex items-start gap-2 text-[#0092DD] text-sm"
                      >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-3xl font-bold text-[#0092DD] mb-5">
                        {item.title}
                      </h3>
                      {isMisi ? (
                        <ul className="space-y-2.5">
                          {items.map((m, i) => (
                            <li
                              key={i}
                              className="flex items-start gap-2.5 text-[#0092DD] text-sm leading-relaxed"
                            >
      ...
      <section className="py-24 bg-linear-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="max-w-2xl mx-auto text-gray-500 leading-relaxed">
              Berbagai keunggulan yang menjadikan SMK Negeri 1 Ciamis pilihan
          ...
          {keunggulanLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[...Array(6)].map((_, i) => (
                <div
                  key={i}
                  className="bg-white p-6 rounded-lg border border-gray-100 animate-pulse space-y-3"
                >
          ...
          <div className="mt-16 text-center">
            <div className="bg-linear-to-r from-[#0092DD] to-[#0077BB] p-12 rounded-3xl shadow-2xl">
              ...
              <p className="text-white/90 mb-8 max-w-2xl mx-auto">
                Jadilah bagian dari SMK Negeri 1 Ciamis dan wujudkan impian
                karirmu di dunia industri dengan pendidikan vokasi berkualitas.
              </p>
