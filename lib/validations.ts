...
export const majorCreateSchema = z.object({
  ...
  studentImage: z.string().max(500).optional().nullable(),
  headerBgColor: z.string().max(50).optional().nullable(),
  activeStudents: z.number().optional().nullable(),
  alumniCount: z.number().optional().nullable(),
  industryPartners: z.number().optional().nullable(),
